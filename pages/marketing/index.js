                    ...
                    <div className="flex flex-col p-8 space-y-4 bg-white w-72 rounded-[15px]">
                        ...
                        <span className="mx-auto">
                            <Link
                                ...
                                className="flex self-center justify-center rounded-lg w-36 text-center text-white font-bold text-base p-2 px-4 bg-light-blue hover:bg-blue-400 transition duration-300">
                                apply now
                            </Link>
                        </span>
                        {/* } */}
                                ...
                                <li>
                                    ...
                                    {/* {user && */}
                                        <span className="">
                                            <Link
                                                href="marketing/register"
                                                className="inline-block px-6 py-2.5 rounded-full text-white font-medium text-xs bg-[#4092CF] hover:bg-blue-400 transition duration-300">Apply Now</Link>
                                        </span>
                                    {/* } */}
                                </li>
                            </ul>
