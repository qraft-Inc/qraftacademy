...
export default function Designers() {
  return <>
    ...
    <div className="pt-24 flex flex-col items-center">
      <h1 className="inline-block px-6 py-2 border-2 border-[#4092CF] text-[#4092CF] font-medium font-bold text-center text-sm leading-tight uppercase rounded-full">
        PRODUCT DESIGN COURSE
      </h1>
      <h2 className="text-4xl font-extrabold leading-10 tracking-tight md:text-center sm:leading-none md:text-5xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-red-400 w-4/6 text-center">
        Launch your Product Design career in just <br />
        12 weeks
      </h2>
    </div>
        ...
        <div className="pointer-events-auto w-[300px] mt-10 ml-auto mr-12 p-[5px] bg-gradient-to-r from-blue-500 to-red-400 rounded-[15px] z-10 hidden lg:block">
          <div className="flex flex-col p-8 space-y-4 bg-white w-72 rounded-[15px]">
            <h1 className="text-center font-semibold">
              The next course starts 18.April.2022
            </h1>
    ...
    <div className="flex flex-col md:flex-row justify-around space-y-2">
      ...
      <div className="md:w-8/12 p-4 space-y-4 pt-8">
        <div className="">
          <h1 className="text-gray-400 text-xl md:text-3xl font-black">
            Course Overview
          </h1>
          <p>
            Our curriculum includes a career development to help you put to
            use the skills leant, a video and audio lectures, assignments, and
            live sessions, hands on projects and mentors to help you grow
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center p-4 border-b ">
              ...
              <p>Become an entry-level product designer</p>
            </li>
            <li className="flex items-center p-4 border-b">
              <AiOutlineArrowRight className="text-blue-500 mr-2" />
            ...
            <li className="flex items-center p-4 border-b">
              <AiOutlineArrowRight className="text-blue-500 mr-2" />
              <p>
                Indentify the type of design or designers role you want to
                pursue
              </p>
            </li>
          </ul>
          ...
          <ol className="border-l-2 border-blue-600 mt-4">
            <li>
              <div className="flex flex-start items-center">
                ...
                <h4 className="text-gray-800 font-semibold md:text-lg -mt-2">
                  Fundamentals of Product Design:
                </h4>
              </div>
              <div className="ml-6 mb-2 pb-2">
                <p className="text-gray-700 mt-2 mb-4">
                  Explore Tools, and frameworks, principle in UX design and
                  identify alternatives roles of designers.
                </p>
              </div>
            </li>
            <li>
              ...
              <div className="ml-6 mb-2 pb-2">
                <p className="text-gray-700 mt-2 mb-4">
                  To create simple and low-tech concepts, all you need to get
                  started is a pen and paper. The goal is to turn your ideas
                  into testable artifacts that you can then use to collect and
                  analyze feedback in the early stages.
                </p>
              </div>
            </li>
            <li>
              ...
              <div className="ml-6 mb-2 pb-2">
                <p className="text-gray-700 mt-2 mb-4">
                  Create computer-based, and allow realistic (mouse-keyboard)
                  user interactions. High-fidelity prototypes take you as
                  close as possible to a true representation of the user
                  interface.
                </p>
              </div>
            </li>
            <li>
              ...
              <div className="ml-6 mb-2 pb-2">
                <p className="text-gray-700 mt-2 mb-4">
                  Create an online portfolio to showcase UX design work and
                  also learn best practices for building a professional
                  network.
                </p>
              </div>
            </li>
        ...
        <div>
          ...
          <p>
            Each Participant will select the Project to work on throughout the
            course
          </p>
        ...
        <div className="flex flex-col items-center md:flex-wrap sm:flex-row space-y-5 sm:space-x-8 pb-8">
          <div>
            <h1 className="text-blue-900 font-bold text-center mb-2">
              Benefits
            </h1>
              ...
              <ul className="space-y-8 text-baset text-center font-medium">
                ...
                <li>
                  ...
                  <span className="">
                    <Link
                      href="designers/register"
                      className="inline-block px-6 py-2.5 rounded-full text-white font-medium text-xs bg-[#4092CF] hover:bg-blue-400 transition duration-300">
