        ...
        <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-12">OUR PRODUCTS</h2>
         <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-8 border rounded-lg bg-blue-50">
            ...
            <p className="text-lg text-gray-800 mb-6">Master essential skills and knowledge through expertly designed courses tailored to your personal and professional growth.</p>
            <button className="font-bold text-blue-700 hover:text-blue-900">
              Learn more →
            </button>
          </div>
          <div className="p-8 border rounded-lg bg-green-50">
            <h3 className="text-2xl font-bold text-gray-900 mb-4"> TechMasters </h3>
            <p className="text-lg text-gray-800 mb-6"> Dive into cutting-edge technology with immersive, hands-on training programs that prepare you for the future of work.</p>
            <button className="font-bold text-blue-700 hover:text-blue-900">
              Learn more →
            </button>
          </div>
          <div className="p-8 border rounded-lg bg-yellow-50">
            ...
            <p className="text-lg text-gray-800 mb-6"> Enhance your career with flexible, industry-relevant programs designed to fit your busy schedule and learning preferences.</p>
            <button className="font-bold text-blue-700 hover:text-blue-900">
              Learn more →
            </button>
          </div>
