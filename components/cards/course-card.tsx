    ...
    return (
        <div className="flex w-full mb-8 md:w-1/2  lg:w-1/4 lg:mb-0 mb-8">
            <figure className="flex flex-col w-full md:w-auto">
                <Image src="/images/gradient.jpeg" height={500} width={500} loading="lazy" alt="ladies discusing qraft" className="object-cover  border-2 object-center w-full h-48 dark:bg-gray-500"></Image>
