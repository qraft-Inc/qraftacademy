    ...
    <>
      <section className="w-full pt-14 pb-7 md:pt-20 md:pb-24" id="courses">
        <Swiper
          ...
          parallax={true}
        >
          {/*Data Literacy Saturday Webinars*/}
          <SwiperSlide className="p-8">
            <figure className="md:grid md:grid-cols-2 mb-12">
              <div className="p-2 pl-6 pr-5 xl:pl-16 xl:pr-20">
                <Image
                  src="https://res.cloudinary.com/filipe256/image/upload/v1652322465/qraftstore/Data_Literacy_ss0cuv.jpg"
                  alt="Data Literacy"
                  layout="responsive"
                  width={400}
                  height={420}
              ...
              <article className="pl-4 md:flex md:flex-col md:justify-center">
                ...
                <p className="leading-7 sm:pr-12 xl:pr-32 lg:text-lg pt-4 pb-8 m-0">
                  Without data, you are blind and deaf and in the middle of a
                  freeway. Join our Data Literacy Series this Saturday. It’s for
                  all professionals, business owners, tech and digital
                  transformation enthusiasts who want to create or learn how to
                  create and benefit from a data driven culture.
                </p>
                <Link href="/datascientists">
                  <a className="rounded-lg w-32 text-center text-white font-bold text-base p-2.5 bg-[#4092CF] hover:bg-blue-400 transition duration-300">
                    Register Now
                  </a>
                </Link>
              </article>
            ...
            <figure className="md:grid md:grid-cols-2 mb-12">
              ...
              <article className="px-4 md:pl-24 md:flex md:flex-col md:justify-center pt-4 order-1">
                ...
                <p className="leading-7 m-0 sm:pr-10 lg:text-lg pt-4 pb-8">
                  Beat the stats and stereotypes, explore and stand out. Build
                  products and a porfolio you are proud to show off and earn
                  from it.
                </p>
                <Link href="./marketing">
                  <a className="rounded-lg w-32 text-center text-white font-bold text-base p-2.5 bg-[#4092CF] hover:bg-blue-400 transition duration-300">
          ...
          <SwiperSlide className="p-8">
            <figure className="md:grid md:grid-cols-2 mb-12">
              ...
              <article className="pl-4 md:flex md:flex-col md:justify-center">
                <h2 className="text-xl font-semibold leading-tight">
                  Free Data Literacy For Organisations
                </h2>
                <p className="leading-7 sm:pr-12 xl:pr-32 lg:text-lg pt-4 pb-8 m-0">
                  Learn how to build a data driven culture in your organisation.
                  The reason why organisations are not data driven is not just
                  technical but also cultural. Normalise using data in your
