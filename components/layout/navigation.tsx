...
const Navigation = () => {
  ...
  return (
    <nav className={cn("grid grid-cols-3 md:grid-cols-7 grid-rows-2 md:grid-rows-1 ", "border-primary-400/40   border-[0.5px] md:border-1")}>
      ...
      <Link href="https://labs.qraftacademy.org/" className={cn("md:col-start-3", boxStyle, linkStyle)}>research</Link>
      <div className={cn("md:col-start-4", boxStyle, linkStyle)}>consult</div>
      <div className={cn("md:col-start-5", boxStyle, linkStyle)}>courses</div>
