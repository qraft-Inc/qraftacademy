...
const Loading = () => {
    return (
        <main className='bg-primary-400 h-screen w-full absolute z-[1000] inset-0 flex items-center justify-center'><svg xmlns="http://www.w3.org/2000/svg" height="200px" width="200px" viewBox="0 0 200 200" className="pencil">
            <defs>
